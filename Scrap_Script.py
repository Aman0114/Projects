class scrap:
    def __init__(self, city,Specialist,n):
        self.city=city
        self.Specialist=Specialist
        self.n=n
    def doctor_links(self,i):
        doc_links=set()
        url=f"https://www.practo.com/search/doctors?results_type=doctor&q=%5B%7B%22word%22%3A%22{self.Specialist}%22%2C%22autocompleted%22%3Atrue%2C%22category%22%3A%22subspeciality%22%7D%5D&city={self.city}&page={i}"
    ...
    def get_info(self,links):
        ...
        for i in links:
            ...
            for k in dictt:
                dictt[k].append(self.extract_info(k,soup))
        return dictt
if __name__ == "__main__":	
    ...
    scrap_=scrap(city,Specialist,n)
    links=scrap_.get_links()
