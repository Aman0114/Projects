...
project_id = 'plated-planet-456517-f9'
dataset_id = 'global_health_data_staging'
transform_dataset_id = 'global_health_data_transformed'
reporting_dataset_id = 'global_health_data_reporting'
...
with DAG(
    ...
    check_file_exists = GCSObjectExistenceSensor(
        ...
        bucket='healthcare_data_0114',  # Replace with your bucket name
        object='healthcare_data/20250419_224944_global_health_data.csv',  # Replace with the file path in the bucket
    ...
    load_csv_to_bigquery = GCSToBigQueryOperator(
        ...
        bucket='healthcare_data_0114',  # Replace with your bucket name
        source_objects=['healthcare_data/20250419_224944_global_health_data.csv'],  # Path to your file in the bucket
